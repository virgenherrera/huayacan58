...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	/*Permisos que se removieron: , user_about_me, user_birthday, user_hometown, user_website, read_stream, offline_access, publish_stream, read_friendlists*/
	public $scope = "email"; 
	public $paramuser = "name";
	...
	*/
	function getUserProfile($param)
	{
		...
		try{ 
			...
			if( $this->scope != ""){
				$params = '?fields='.$this->scope;
			}
			if( $params != ""){
				$params .=  ",".$this->paramuser;
			}
			else{
				$params = '?fields='.$this->paramuser;
			}
			$data = $this->api->api('/me'.$params); 
